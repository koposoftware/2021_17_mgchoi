...
<p>Re-distributed by <a href="https://themewagon.com/" target="_blank">Themewagon</a>
    ...
    <script src="${pageContext.request.contextPath}/resources/master/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="${pageContext.request.contextPath}/resources/master/js/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="${pageContext.request.contextPath}/resources/master/js/bootstrap.min.js"></script>
    <!-- Plugins js -->
    <script src="${pageContext.request.contextPath}/resources/master/js/plugins.js"></script>
    <!-- Active js -->
