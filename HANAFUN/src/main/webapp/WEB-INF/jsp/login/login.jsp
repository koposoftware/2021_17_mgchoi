...
<head>
  ...
  <script>
		...
		function checkForm(){
	    	...
	    	let fd = document.loginForm
			
			if(isNull(fd.p_member_id,'아이디를입력하세요')){
				return false
			}
			if(isNull(fd.p_member_pwd,'비밀번호를입력하세요')){
				return false
			}
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="post" name="loginForm" onsubmit="return checkForm()">
                    <label>아이디</label>
                    <div class="mb-3">
                      <input type="text" name="id" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon">
                    </div>
                    <label>비밀번호</label>
                    <div class="mb-3">
